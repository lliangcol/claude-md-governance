...
try:
    ...
    def _validate_required_sections(errors: List[str], value: object) -> None:
        if value is None:
            return
    ...
    def _validate_sensitive_paths(errors: List[str], value: object) -> None:
        if value is None:
            return
        if not isinstance(value, list):
    ...
    def _validate_hooks(errors: List[str], value: object) -> None:
        if value is None:
    ...
    def _validate_policy(policy: object) -> List[str]:
        ...
        if ci is not None:
            if not isinstance(ci, dict):
                ...
                allowed = {"auto", "github", "gitlab", "jenkins", "buildkite", "codeup", "none"}
