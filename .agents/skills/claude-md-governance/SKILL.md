---
name: Codex-md-governance
description: Evaluate, repair, and verify AGENTS.md quality governance for a repository. Use this skill when AGENTS.md, .Codex settings, hooks, memory, AI coding rules, or agent governance are discussed.
---

# AGENTS.md Governance Skill

Use this skill to keep repository AI instructions short, enforceable, and safe.

## Operating rules

1. Treat AGENTS.md as always-loaded context. Keep it short and global.
2. Move long procedures into skills or docs, referenced by path from AGENTS.md.
3. Use local AGENTS.md files or path-scoped rules for sensitive directories such as auth, billing, payments, migrations, MQ consumers, and infra.
...
6. After changing AGENTS.md or governance files, run:
...
5. Add or update local AGENTS.md files under sensitive modules.
